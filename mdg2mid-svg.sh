...
#	 FILE:	mdg2mid-svg.sh
#
#	USAGE:	mdg2mid-svg.sh n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16
#
...
#		of a particular Musical Dice Game (MDG) minuet based on the rules given in 
#		K. 516f or K. 294d or K. Anh. C 30.01 (1792 publication attributed to W.A. Mozart 
...
# ALTERNATIVELY, comment out all three conditionals above and dbNum formula then use:
...
# create SVG
abcm2ps ./$filen -O ./"K516f-$fileInd.svg" -g

# create MIDI
abc2midi ./$filen -quiet -silent -o ./"K516f-$fileInd.mid"
#
##
###
