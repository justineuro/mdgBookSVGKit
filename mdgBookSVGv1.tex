...
% IMSPL for Musikalisches W\"{u}rfelspiel K 516.f
% Wikipedia: Musikalisches W\"{u}rfelspiel
% Opus-Infinity Site
% Amaranth Publishing
% Noguchi, Hideo.  \hyperref{(http://www.asahi-net.or.jp/~rb5h-ngc/e/k516f.htm}{}{}{``Mozart – Musical Game in C K. 516f*(http://www.asahi-net.or.jp/~rb5h-ngc/e/k516f.htm)"},	Mozart Studies Online
% Mozart \hyperref{http://mozart.qvwx.de/index.en.html}{category}{name}{(http://mozart.qvwx.de/index.en.html)} (Browser-based implementation with score and MIDI generator)
% Debian 8 (Jessie) for OS
% Bash references
% abcm2ps
% abcmid
% Inkscape
% Ghostscipt
% \LaTeX
% John henrry Fogarty - generate cover; Peter Wilson: How can I design a book cover%3F - TeX - LaTeX Stack Exchange.html
% StackExchange for including SVGs in \LaTeX
